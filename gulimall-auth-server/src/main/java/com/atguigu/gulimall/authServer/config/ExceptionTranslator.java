...
public class ExceptionTranslator {
    ...
    @ExceptionHandler(value = TooManySmsCodeRequestException.class)
    public R tooManySmsCodeRequestExceptionHandler(TooManySmsCodeRequestException e, HttpSession session) {
